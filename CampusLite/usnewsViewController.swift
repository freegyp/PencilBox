...
class usnewsViewController: UIViewController,UITableViewDelegate,UITableViewDataSource,NSXMLParserDelegate {
    ...
    override func viewDidLoad() {
        ...
        if let urlToSend:NSURL = NSURL(string: "http://feeds.abcnews.com/abcnews/usheadlines"){
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell:usnewsCell = self.newsTableView.dequeueReusableCellWithIdentifier("usnewscell", forIndexPath: indexPath) as! usnewsCell
